...
//                System.out.println(rasporedAImpl.getRaspored().getSviTermini());
//            }catch (IOException e){
...
//                    linija = scanner.nextLine();
//                    rasporedAImpl.exportCSV(linija, rasporedAImpl.raspored.sviTermini, linija);
//                }else if(linija.contains(".json")){
//                    System.out.println("Unesite destinaciju fajla: ");
//                    linija = scanner.nextLine();
//                    rasporedAImpl.exportJSON(linija, rasporedAImpl.raspored.sviTermini, linija);
//                }else if(linija.contains(".pdf")){
//                    System.out.println("Unesite destinaciju fajla: ");
//                    linija = scanner.nextLine();
//                    rasporedAImpl.exportPDF(linija, rasporedAImpl.raspored.sviTermini, linija);
//                }else{
//                    System.out.println("Unesite destinaciju fajla: ");
//                    linija = scanner.nextLine();
//                    rasporedAImpl.exportPDF(linija, rasporedAImpl.raspored.sviTermini, linija);
